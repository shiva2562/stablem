...
class signup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        '/content':(BuildContext context) => MyApp(),
            ...
            builder:(context)=> Center(
              child: Column(
                ...
                children: <Widget>[
                 ...
                 FlatButton(
                  child:Icon(Icons.input,size: 50,color: Colors.black38,),
                  onPressed: ()async{
                    SharedPreferences pref = await SharedPreferences.getInstance();
                    if(pref.getString('email')==null || pref.getString('pass')==null){
                      Navigator.pushNamed(context, '/log');
...
class _signupdState extends State<signupd> {
  ...
  final DocumentReference tableref= Firestore.instance.document('userdata/table');
  Map<String,String> data;
  void signUp() async {
    if(_formkey.currentState.validate()){
      _formkey.currentState.save();
      try{
        cuser= await FirebaseAuth.instance.createUserWithEmailAndPassword(email: _newemail, password: _newpassword);
        refe.document(cuser.uid).setData({'email':_newemail,'username':_newusername,'role':van,'plist':[],'table':false,'pic':'','nop':1,'whatsapp':'','mobile':_newmobile,'entryno':_newentryno});
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            DropdownButton<String>(
                              ...
                              items: <String>['Professor','TA'].map<DropdownMenuItem<String>>((String val){
